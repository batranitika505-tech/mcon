                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="w-full md:w-1/2 bg-white flex flex-col justify-between py-24 md:py-0 md:justify-center px-10 sm:px-12 md:px-24 relative overflow-y-auto">
                            ...
                            <nav className="flex flex-col space-y-10 sm:space-y-12 md:space-y-8">
                                {navLinks.map((link, i) => (
                                    <motion.div
                                        key={link.name}
                                    ...
                                    >
                                        ...
                                        >
                                            <span className={`text-[11px] sm:text-[13px] md:text-sm font-bold text-[#F58220] transition-opacity ${activeSection === link.id ? 'opacity-100' : 'opacity-40 group-hover:opacity-100'}`}>0{i + 1}</span>
